package com.devfutech.paradisonesia.domain.model.expandable_list_data
...
internal object ExpandableListData {
    val data: HashMap<String, List<String>>
        get() {
            ...
            expandableListDetail["Tanggal Pelaksanaan"] = myFavCricketPlayers
            expandableListDetail["Rencana Perjalanan"] = myFavFootballPlayers
            expandableListDetail["Include"] = myFavTennisPlayers
            expandableListDetail["Exclude"] = myFavTennisPlayers
            expandableListDetail["Fasilitas & Layanan"] = myFavTennisPlayers
            expandableListDetail["FAQ"] = myFavTennisPlayers
            expandableListDetail["Syarat & Ketentuan"] = myFavTennisPlayers
            expandableListDetail["Penilaian Produk"] = myFavTennisPlayers
            expandableListDetail["Paket Lainnya"] = myFavTennisPlayers
